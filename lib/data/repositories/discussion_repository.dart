...
class DiscussionRepository {
  ...
  Future<void> sendMessage({
    ...
    final autoDeleteAt = DateTime.now()
        .add(const Duration(days: AppConstants.messageRetentionDays));
  ...
  Future<void> saveReceivedMessage({
    ...
    final autoDeleteAt =
        sentAt.add(const Duration(days: AppConstants.messageRetentionDays));
  ...
  Future<List<DiscussionMessage>> getMessagesForChapter(
